...
class StatefulController:
    ...
    def analyze_message(self, message: str) -> Dict[str, Any]:
        ...
        if any(word in message_lower for word in ["power", "electricity", "watt", "consumption", "generation"]):
            return {"intent": "power", "confidence": 0.85}
        
        # Check for battery queries
        if any(word in message_lower for word in ["battery", "capacity", "charge", "energy", "storage"]):
